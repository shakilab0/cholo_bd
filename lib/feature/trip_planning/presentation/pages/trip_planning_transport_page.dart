...
class TripPlanningTransportPage extends GetView<TripPlanningController> {
  const TripPlanningTransportPage({super.key});
      ...
      body: Column(
        children: [
          Expanded(
            child: Column(
              children: [
                Expanded(child: StepTransport(controller: controller)),
                Row(
                  ...
                  children: List.generate(
                    ...
                    (i) => AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: i == 3 ? AppColor.primary : AppColor.border,
          ...
          _nextButton(context, stepIndex: 3),
        ],
      ),
    );
  }
