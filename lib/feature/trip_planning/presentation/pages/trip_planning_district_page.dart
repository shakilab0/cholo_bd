...
class TripPlanningDistrictPage extends GetView<TripPlanningController> {
  const TripPlanningDistrictPage({super.key});
      ...
      body: Column(
        children: [
          Expanded(
            child: Column(
              children: [
                Expanded(child: StepDistrict(controller: controller)),
                Row(
          ...
          _nextButton(context, stepIndex: 0),
        ],
      ),
    );
  }
