...
class TripPlanningPlacesPage extends GetView<TripPlanningController> {
  const TripPlanningPlacesPage({super.key});
      ...
      body: Column(
        children: [
          Expanded(
            child: Column(
              children: [
                Expanded(child: StepPlaces(controller: controller)),
                Row(
          ...
          _nextButton(context, stepIndex: 1),
        ],
      ),
    );
  }
